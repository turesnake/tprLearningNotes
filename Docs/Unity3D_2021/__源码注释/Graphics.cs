...
namespace UnityEngine
{
    ...
    public class Graphics
    {
        ...
        //
        //   dest:
        //     The destination RenderTexture. Set this to null to blit directly to screen. See
        //     description for more information.
        //
        //   mat:
        //     Material to use. Material's shader could do some post-processing effect, for
        //     example.
        //
        //   pass:
        ...
        //   setup:
        //     Full render target setup information.
        public static void SetRenderTarget(RenderBuffer colorBuffer, RenderBuffer depthBuffer, [Internal.DefaultValue("0")] int mipLevel, [Internal.DefaultValue("CubemapFace.Unknown")] CubemapFace face, [Internal.DefaultValue("0")] int depthSlice);
        [ExcludeFromDocs]
        ...
        //   setup:
        //     Full render target setup information.
        public static void SetRenderTarget(RenderTexture rt, [Internal.DefaultValue("0")] int mipLevel, [Internal.DefaultValue("CubemapFace.Unknown")] CubemapFace face, [Internal.DefaultValue("0")] int depthSlice);
        //
        // 摘要:
        ...
        //     If a compute shader dispatch is the next item to be submitted then this parameter
        //     is ignored.
        public static void WaitOnAsyncGraphicsFence(GraphicsFence fence, [Internal.DefaultValue("SynchronisationStage.PixelProcessing")] SynchronisationStage stage);
        //
        // 摘要:
