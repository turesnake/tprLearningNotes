...
#                 相关信息
# ------------------------------------------------------- #
这个函数收集了 目标光源 所捕捉到的 shadow casters, 将他们收集在一个 AABB 盒中,
返回给 调用者.

请问 unity 是如何 实现这个过程的 ?

这是是不是就是 那个介绍 srp管线的视频中提及的, 对 shadow 的 cull 操作 ??



# ====================== 086 ============================ #
#    win10 平台中, 无法在 Frame Debug 窗口中显示 shadow map 的原因是啥 ???
# ------------------------------------------------------- #
