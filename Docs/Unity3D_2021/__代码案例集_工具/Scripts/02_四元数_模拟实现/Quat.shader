    ...
    SubShader
    {
        ...
        pass
        {
            ...
            v2f VERT(a2v i)
            {
                ...
                float4 _Quaternion_V1=Multi_Granlam(_Quaternion_P,_Quaternion_V);//v'=pvp-1 这里要用Gralama积
            ...
            float4 Multi_Granlam(float4 Q1,float4 Q2)//定义四元数的乘法函数 Gralama积
            {
