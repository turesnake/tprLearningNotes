...
Shader "tpr/quad"
{
    ...
    Properties
    {
        ...
        //       Sphere in Quad 
        // ----------------------------- //
        _FlatMap("Flat Map", 2D) = "white" {}
        _FlatMapRadius("Flat Map Radius", Float) = 10.0
        _CenterPosWS("Flat Map Center Pos", Vector) = (0,0,0,0)

        _QuadCoord0("Quad Coord Row 0", vector) = (0,0,0,0)
        _QuadCoord1("Quad Coord Row 1", vector) = (0,0,0,0)
        _QuadCoord2("Quad Coord Row 2", vector) = (0,0,0,0)
    ...
    */
    ...
    // 暂时先屏蔽，以便在 inspector 上看到 public properties
