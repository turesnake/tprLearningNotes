...
// the self-advection is done purely rotational on all scales.  自平流在所有尺度上都是纯旋转的。
// therefore i dont need any divergence-free velocity field.    所以我不需要任何无散度的速度场。
// with stochastic sampling i get the proper "mean values" of rotations  通过随机抽样，我得到了高阶尺度下随时间旋转的适当“平均值”。
